      ...
      <nav className="bg-green-100 border-gray-200 dark:bg-gray-900">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-2">
          <div className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="icon.png" className="object-contain h-16 w-16" alt="Logo" />
          </div>
          <div className="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <button onClick={toggleMobileMenu} type="button" className="mobile-menu-button inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mega-menu" aria-expanded={mobileMenuOpen}>
          ...
          <div id="mega-menu" className={`desktop-menu-items items-center justify-between w-full md:flex md:w-auto md:order-1 ${mobileMenuOpen ? 'hidden' : ''}`}>
