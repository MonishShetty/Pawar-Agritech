                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm">
                                        <label htmlFor="terms" className="font-light text-white dark:text-gray-300">I accept the <a className="font-medium text-gray-200 hover:underline dark:text-primary-500" href="#">Terms and Conditions</a></label>
                                    </div>
                                </div>
                                ...
                                <Link to='/login' className="text-xl font-light text-white dark:text-gray-400">
                                    Already have an account? <a href="#" className="font-large text-white  hover:bg-white hover:text-green-900  rounded-lg p-1 dark:text-primary-500">Login here</a>
                                </Link>
                            </form>
                        </div>
                    </div>
